...
import { downloadLayoutGuidePng, optimizeArtwork } from '@/domain/cards/artwork'
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const [ev, rs, ts, bs, artwork, gameStyle] = await Promise.all([
        getEvent(currentWorkspace.id, eventId), listRuleSets(currentWorkspace.id, eventId), listCardTemplates(currentWorkspace.id, eventId), listCardBatches(currentWorkspace.id, eventId), getEventCardArtwork(currentWorkspace.id,eventId), getEventCardGameStyle(currentWorkspace.id,eventId),
      ])
