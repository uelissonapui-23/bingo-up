  ...
  return <div className="space-y-6">
    ...
    <div className="grid gap-5 lg:grid-cols-[minmax(0,1.3fr)_minmax(320px,.7fr)]">
      <div className="space-y-5">
        ...
        <Card><h2 className="text-lg font-black">Próximo passo recomendado</h2><p className="mt-2 text-sm text-slate-600">Configure a cartela, gere o lote, imprima, registre as vendas e só então inicie o sorteio. O fluxo acima deixa todas essas etapas sempre acessíveis.</p><div className="mt-4 flex flex-wrap gap-2"><Link to={`/eventos/${event.id}/cartelas/configuracao?aba=layouts`}><Button>Começar pela cartela</Button></Link><Link to={`/eventos/${event.id}/sorteio`}><Button variant="secondary">Ir ao sorteio</Button></Link></div></Card>
      </div>
      <div className="space-y-5">
