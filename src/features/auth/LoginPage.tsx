...
export function LoginPage() {
  ...
  async function submit(e: FormEvent) {
    ...
    try {
      ...
      if (error) setError(error.message.toLowerCase().includes('email not confirmed') ? 'Confirme seu e-mail antes de entrar.' : 'Não foi possível entrar. Confira e-mail e senha.')
    } catch {
