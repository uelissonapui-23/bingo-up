...
export function PublicCardPlaceholderPage(){
  ...
  return <main className="min-h-dvh bg-slate-950 text-white"><div className="mx-auto max-w-5xl p-3 sm:p-5">
    ...
    <p className="py-5 text-center text-xs text-slate-600">A tela acompanha o sorteio automaticamente. A conferência oficial continua sendo feita pelo organizador ou operador.</p>
  </div></main>
}
