...
export function AppRouter(){
  return <Suspense fallback={<RouteLoading/>}><Routes>
    ...
    <Route element={<RequireAuth/>}><Route element={<RequirePlatformOwner/>}><Route path="/master" element={<MasterPage/>}/></Route><Route path="/convites/vendedor/:token" element={<SellerInvitePage/>}/><Route path="/convites/operador/:token" element={<OperatorInvitePage/>}/><Route element={<RequirePlatformAccess/>}><Route path="/configurar-organizador" element={<div className="bingoup-app min-h-dvh p-4"><WorkspaceOnboardingPage/></div>}/><Route element={<RequireWorkspace/>}><Route element={<AppShell/>}>
