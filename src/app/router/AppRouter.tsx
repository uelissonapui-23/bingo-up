...
export function AppRouter(){
  return <Suspense fallback={<RouteLoading/>}><Routes>
    ...
    <Route element={<RequireAuth/>}><Route path="/acessos" element={<AccessCenterPage/>}/><Route path="/organizador" element={<OrganizerCenterPage/>}/><Route path="/venda" element={<SellerCenterPage/>}/><Route path="/venda/:eventId" element={<SellerEventPage/>}/><Route path="/operador" element={<OperatorCenterPage/>}/><Route path="/operador/:eventId/sorteio" element={<OperatorDrawPage/>}/><Route path="/operador/:eventId/tv" element={<OperatorTvPage/>}/><Route path="/operador/:eventId/ganhadores" element={<OperatorWinnersPage/>}/><Route path="/cliente" element={<BuyerCenterPage/>}/><Route path="/cliente/:eventId" element={<BuyerEventPage/>}/><Route element={<RequirePlatformOwner/>}><Route path="/master" element={<MasterPage/>}/><Route path="/master/conferencia/:candidateId" element={<MasterConferencePage/>}/><Route path="/master/sorteio/:sessionId" element={<MasterDrawSessionPage/>}/></Route><Route path="/convites/vendedor/:token" element={<SellerInvitePage/>}/><Route path="/convites/operador/:token" element={<OperatorInvitePage/>}/><Route element={<RequirePlatformAccess/>}><Route path="/configurar-organizador" element={<div className="bingoup-app min-h-dvh p-4"><WorkspaceOnboardingPage/></div>}/><Route element={<RequireWorkspace/>}><Route element={<AppShell/>}>
